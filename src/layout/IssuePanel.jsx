...
export default function IssuePanel() {
  ...
  const handleCreateIssue = () => {
    if (newIssue.title && newIssue.description) {
      ...
      setNewIssue({ title: "", description: "", category: "General", attachment: "" });
      setShowModal(false);
    }
  };
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-xs text-gray-500 mb-2">
                Category: {issue.category} · Uploaded by {issue.uploadedBy} · {issue.date}
              </p>
              <span
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 relative">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-4">Report New Issue</h3>
            <div className="space-y-4">
              ...
              <input
                ...
                onChange={(e) => setNewIssue({ ...newIssue, attachment: e.target.value })}
                className="w-full border rounded-md px-3 py-2 focus:ring-2 focus:ring-red-500"
              />
              <button
